...
public:
    // constructors
    Request() : _request(""), _path(""), _method(""), _version(""), _end(false), _valid(false)
    {
        init_header_map();
    }

    Request(std::string new_request) : _request(""), _path(""), _method(""), _version(""), _end(false), _valid(false)
    {
        init_header_map();
        addp(new_request);
    }

    Request(const Request &src) : _request(""), _path(""), _method(""), _version(""), _end(false), _valid(false)
    {
        init_header_map();
        addp(src._request);
    }
